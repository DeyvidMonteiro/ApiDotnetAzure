...
public class UpdateUserUseCase : IUpdateUserUseCase
{
    ...
    public async Task Execute(ResquestUpdateUserJson request)
    {
    ...
    public async Task Validate(ResquestUpdateUserJson request, string currentEmail)
    {
        ...
        { 
            ...
            if (userExist)
                result.Errors.Add(new FluentValidation.Results.ValidationFailure("email", ResourceMessagesExceptions.EMAIL_INVALID));
